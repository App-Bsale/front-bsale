    ...
    return (
        <Layout>
            ...
            <h2>Retos asignados</h2>
                <Collapse collapsible='icon' expandIconPosition='end' defaultActiveKey={['1']} onChange={console.log('hola')} >
                    <Panel header={<div className='header-challenge'>
                                <h4>Desarrollador Web Junior</h4>
                                <Button type="primary" className='button-challenge'>Iniciar</Button>
                            </div>} 
                    key="1">
                        <p>{text}</p>
                    </Panel>
